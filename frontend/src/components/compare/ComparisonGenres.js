...
export default function ComparisonGenres({ radarData, nameA, nameB }) {
	...
	return (
		<Card className="bg-[#0a0f1d]/85 border border-white/5 text-slate-100 overflow-hidden shadow-xl backdrop-blur-md h-full">
			<CardHeader className="px-6 pt-5 pb-4 border-b border-white/2">
